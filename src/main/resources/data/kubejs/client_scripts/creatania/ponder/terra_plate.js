...
const displayTerraPlateFromBlocksScene = (params) => (scene, util) => {
    ...
    **************************************/
    ...
    scene.text(50, "You know how to setup the Agglomeration Plate", offsetTopOf(util)(livingrock_0));
    scene.idle(60);
    /***********************************      
...
onEvent("ponder.registry", event => {
    event
        .create("botania:terra_plate") // full block id 
        .scene(
            "terra_plate_scene", // unique scene identifier
            "Mana Ducts don't quack!", // scene title
            "creatania:mana_ducts", // namespace and path to nbt file inside ponder folder
            displayTerraPlateFromBlocksScene({ blockId: "botania:terra_plate" })
        );
