...
public class Advancements {
  ...
  // mana machinery
    MANA_MACHINE_COMPONENT = create("mana_machine_component", b -> b.icon(Blocks.MANA_CASING.get())
      .title("Magical... Stress")
      .description("Obtain a mana machine component, the core of all mana machines")
      .after(ROOT)
      .special(NOISY)
      .whenIconCollected()),
    MANA_GENERATOR = create("mana_generator", b -> b.icon(Blocks.MANA_GENERATOR.get())
    ...
    MANADUCT_TIER_4 = create("manaduct_tier_4", b -> b.icon(Blocks.GAIA_MANADUCT_BLOCK.get())
      ...
      .special(NOISY)
      .whenIconCollected()),
    MANA_CONDENSER = create("mana_condenser", b -> b.icon(Blocks.MANA_CONDENSER.get())
      ...
      .special(NOISY)
      .whenIconCollected()),
    MANA_MOTOR = create("mana_motor", b -> b.icon(Blocks.MANA_MOTOR.get())
