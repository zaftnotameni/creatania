...
public class CommonConfig {
  ...
  public static final ForgeConfigSpec.ConfigValue<Integer> MANA_CONDENSER_THROTTLE_MINIMUM_TICKS_PER_BLOCK;
  ...
  static {
    ...
    MANA_GENERATOR_SU_PER_RPM = BUILDER.define("su_per_rpm", 32);
    ...
    MANA_CONDENSER_SU_PER_RPM = BUILDER.define("su_per_rpm", 16);
    MANA_CONDENSER_MANA_PER_ITEM = BUILDER.define("mana_per_item", 0);
    ...
    MANA_CONDENSER_THROTTLE_MINIMUM_TICKS_PER_BLOCK = BUILDER.define("mana_condenser_throttle_min_ticks_per_block", 10);
    MANA_CONDENSER_THROTTLE_PER_RPM_BELOW_MAX = BUILDER.define("mana_condenser_throttle_per_rpm_below_max", 2);
    BUILDER.pop();
