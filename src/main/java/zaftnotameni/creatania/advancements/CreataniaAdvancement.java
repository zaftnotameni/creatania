...
public class CreataniaAdvancement {
  ...
  public CreataniaAdvancement(String id, UnaryOperator<Builder> b) {
    ...
    CreataniaAdvancements.ENTRIES.add(this);
  }
  ...
  public boolean isAlreadyAwardedTo(Player player) {
    ...
    Advancement advancement = sp.getServer()
      .getAdvancements()
      .getAdvancement(CreataniaIndex.resource(id));
    if (advancement == null)
      return true;
  ...
  public void save(Consumer<Advancement> t) {
    ...
    datagenResult = builder.save(t, CreataniaIndex.resource(id).toString());
  }
  ...
  public class Builder {
    ...
    public Builder externalTrigger(CriterionTriggerInstance trigger) {
      builder.addCriterion(String.valueOf(keyCreataniaIndex), trigger);
